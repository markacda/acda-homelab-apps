...
function createBaseLayers() {
  ...
  if (loStore['bingKey'] != undefined) BingMapsAPIKey = loStore['bingKey'];
  ...
  if (loStore['mapboxKey'] != undefined) MapboxAPIKey = loStore['mapboxKey'];

  if (MapboxAPIKey) {
    world.push(
      new ol.mapboxStyle.MapboxVectorLayer({
  ...
  europe.push(
    createGeoJsonLayer('UK A2A Refueling', 'uka2arefueling', 'geojson/UK_Mil_AAR_Zones.geojson', 'rgba(52, 50, 168, 0.3)', 'rgba(52, 50, 168, 1)')
  );
  europe.push(
    createGeoJsonLayer(
      'UK AWACS Orbits',
  ...
  us.push(
    createGeoJsonLayer('US A2A Refueling', 'usa2arefueling', 'geojson/US_A2A_refueling.geojson', 'rgba(52, 50, 168, 0.3)', 'rgba(52, 50, 168, 1)')
  );
  ...
  if (uk_advisory) {
    europe.push(
      createGeoJsonLayer('uka_airports', 'uka_airports', 'geojson/uk_advisory/airports.geojson', 'rgba(255, 255, 255, 1)', 'rgba(255, 255, 255, 1)')
    );
    europe.push(
      createGeoJsonLayer(
        'uka_airspaces',
