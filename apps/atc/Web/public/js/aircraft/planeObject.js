...
PlaneObject.prototype.updateIcon = function() {
    ...
    if ( g.enableLabels && (!multiSelect || (multiSelect && this.selected)) &&
        ...
        if (atcStyle) {
            ...
            let atcAlt = Math.round(convert_altitude(alt / 100.0, DisplayUnits)).toString().padStart(3, '0');
            labelText += atcAlt + ' ' + atcSpeed + verticalRateTriangle;
            if (!!this.icaoType || !!this.wtc)
...
PlaneObject.prototype.updateMarker = function(moved) {
    ...
    if (atcStyle && this.showSpeedVector && this.speedVectorLat != null && this.speedVectorLon != null && this.position != null) {
        ...
        const lineCoords = [
            this.olPoint.getCoordinates(),
            ol.proj.fromLonLat([this.speedVectorLon, this.speedVectorLat])
        ];
