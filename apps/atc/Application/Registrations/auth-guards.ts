 ...
 * `trustedEmbedOrigins` opts ATC into the Home Assistant embed bypass (issue #186).
 */
export function createAtcGuards(options: { verify?: TokenVerifier; secret?: Uint8Array; trustedEmbedOrigins?: string[] } = {}): AtcGuards {
