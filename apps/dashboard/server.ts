...
// server.ts directly or the compiled dist/server.js. startServer serves it;
// the explicit GET / below returns the shell.
...
// Serve the dashboard shell for the root. (/healthz + public/ come from startServer.)
